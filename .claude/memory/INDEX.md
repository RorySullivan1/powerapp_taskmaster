...
- **`cmpSelection` is IN USE again** (issue type, issue impact, transaction currency). The
  2026-08-13 conversion to comboboxes was reverted: the reported "type not landing" was a
  VOCABULARY mismatch, not the control. Do not convert them again without evidence.
