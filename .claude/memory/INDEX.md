...
- **NOBODY owes the blended notional** since Power BI was dropped (2026-08-17). Needs an FX
  dimension (currency, rate, as-of date) in the model, or the cross-currency figure stays out
  of scope. **Decision owed.**
