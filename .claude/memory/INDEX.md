...
- **`project_phase` is DERIVED BY THE APP, not picked** (2026-08-13): open issue -> Stalled;
  ...
  are terminal. PENDING IN SHAREPOINT: add `Stalled`, set the default to `Not Started`. **No orphaned controls: the user DELETES a screen before pasting it back.**
